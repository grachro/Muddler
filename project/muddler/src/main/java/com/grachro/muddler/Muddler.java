...
public class Muddler {
	...
	public static void init(String... args) {
		...
		String persistenceUnitNames = System.getProperty("persistenceUnitNames");
		...
		if (persistenceUnitNames == null) {
			...
			System.out.println("-DpersistenceUnitNames is " + persistenceUnitNames);
			for (String name : persistenceUnitNames.split(",")) {
				System.out.println("set persistenceUnitName:" + name);
				entityManagerFactoryMap.put(name, Persistence.createEntityManagerFactory(name));
			}
		}
		...
		{
			String externalStaticFileLocation = System.getProperty("externalStaticFileLocation");
			if (StringUtils.isNotEmpty(externalStaticFileLocation)) {
				System.out.println("set externalStaticFileLocation:" + externalStaticFileLocation);
